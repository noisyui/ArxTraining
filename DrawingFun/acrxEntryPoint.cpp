...
class CDrawingFunApp : public AcRxArxApp {

public:
	CDrawingFunApp () : AcRxArxApp () {}
	...
	// function of the CDrawingFunApp class.
	...
	// ACED_ARXCOMMAND_ENTRY_AUTO(CDrawingFunApp, AsdkMyGroup, MyCommand, MyCommandLocal, ACRX_CMD_MODAL)
	...
	// ACED_ARXCOMMAND_ENTRY_AUTO(CDrawingFunApp, AsdkMyGroup, MyPickFirst, MyPickFirstLocal, ACRX_CMD_MODAL | ACRX_CMD_USEPICKSET)
	...
	// ACED_ARXCOMMAND_ENTRY_AUTO(CDrawingFunApp, AsdkMyGroup, MySessionCmd, MySessionCmdLocal, ACRX_CMD_MODAL | ACRX_CMD_SESSION)
	...
	// or integer.
	// ACED_ADSFUNCTION_ENTRY_AUTO(CDrawingFunApp, MyLispFunction, false)
...
//-----------------------------------------------------------------------------
IMPLEMENT_ARX_ENTRYPOINT(CDrawingFunApp)
